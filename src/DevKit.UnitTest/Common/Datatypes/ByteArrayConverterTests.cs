...
namespace Energistics.Etp.Common.Datatypes
{
    ...
    public class ByteArrayConverterTests
    {
        ...
        private const string Base64Gzip = "H4sIAAAAAAAEAB3HUQqAIAwA0KuIB3DhZ2THqG+pocLUcKPV7YPe31t2JDJPpcbBZpFrBlBVhw1HKizlYNdHgv9vJTijRNAiXOn21vCRscYNB5fegvVusgbWD423PKBWAAAA";
        ...
        {
            var dataObject = new v11.Datatypes.Object.DataObject();
            dataObject.Data = Convert.FromBase64String(Base64Gzip);
