...
{
    /// <summary>
    /// Provides common functionality for ChannelDataFrame store capabilities.
    /// </summary>
    public class CapabilitiesStore : Etp12ProtocolCapabilities, ICapabilitiesStore
    {
        ...
        /// </summary>
        public long? MaxFrameResponseRowCount { get; set; }

        /// <summary>
        /// The maximum time period in seconds for updates to a channel to be visible.
        /// </summary>
        public long? FrameChangeDetectionPeriod { get; set; }
