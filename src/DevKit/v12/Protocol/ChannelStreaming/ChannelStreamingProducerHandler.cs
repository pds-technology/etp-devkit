...
namespace Energistics.Etp.v12.Protocol.ChannelStreaming
{
    ...
    public class ChannelStreamingProducerHandler : EtpProtocolHandler, IChannelStreamingProducer
    {
        ...
        /// </summary>
        /// <value>The minimum message interval.</value>
        public int MinMessageInterval { get; private set; }
        ...
        public virtual long ChannelMetadata(IMessageHeader request, IList<ChannelMetadataRecord> channelMetadataRecords, MessageFlags messageFlag = MessageFlags.FinalPart)
        {
        ...
        protected virtual void HandleStart(IMessageHeader header, Start start)
        {
            ...
            MinMessageInterval = start.MinMessageInterval;
