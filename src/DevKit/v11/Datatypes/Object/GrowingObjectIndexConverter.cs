...
{
    /// <summary>
    /// Converts a <see cref="GrowingObjectIndex"/> to and from JSON.
    /// </summary>
    /// <seealso cref="Newtonsoft.Json.JsonConverter" />
    public class GrowingObjectIndexConverter : JsonConverter
    {
        ...
        {
            return typeof(GrowingObjectIndex) == objectType;
        }
        ...
        {
            var index = value as GrowingObjectIndex;
