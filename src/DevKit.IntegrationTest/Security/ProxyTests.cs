...
namespace Energistics.Etp.Security
{
    ...
    public class ProxyTests : IntegrationTestBase
    {
        ...
        {
            SetUpWithProxy(Common.Datatypes.WebSocketType.Native, EtpVersion.v11);
        ...
        {
            SetUpWithProxy(Common.Datatypes.WebSocketType.WebSocket4Net, EtpVersion.v11);

            await ProxyTestBody();
        }

        private async Task ProxyTestBody()
        {
            ...
            var task = new Task<bool>(() => _client.IsWebSocketOpen);
